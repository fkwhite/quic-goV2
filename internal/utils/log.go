...
// DefaultLogger is used by quic-goV2 for logging.
...
func readLoggingEnv() LogLevel {
	...
	default:
		fmt.Fprintln(os.Stderr, "invalid quic-goV2 log level, see https://github.com/fkwhite/quic-goV2/wiki/Logging")
		return LogLevelNothing
	}
}
